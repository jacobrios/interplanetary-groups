...
const DC = {
  ...
  label: 'rgba(236,237,242,0.55)',
  title: 'rgba(236,237,242,0.9)',
  subtitle: 'rgba(236,237,242,0.5)',
  postitBg: '#fef4a8',
  postitText: '#5a4a2a',
  ...
  return (
    <div ref={ref} data-dc-slot={id} style={{ position: 'relative', flexShrink: 0 }}>
      ...
      <div ref={cardRef} className="dc-card"
        style={{ borderRadius: 2, boxShadow: '0 1px 3px rgba(0,0,0,.08),0 4px 16px rgba(0,0,0,.06)', overflow: 'hidden', width, height, background: '#15161e', ...style }}>
    ...
    <div onClick={() => ctx.setFocus(null)}
      ...
      <div
        ...
        <div onClick={(e) => e.stopPropagation()} style={{ width: width * scale, height: height * scale, position: 'relative' }}>
          <div style={{ width, height, transform: `scale(${scale})`, transformOrigin: 'top left', background: '#15161e', borderRadius: 2, overflow: 'hidden',
