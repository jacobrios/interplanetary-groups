...
// fieldStyle, labelStyle, neverMindButton, saveButton, shrinkColumn, and
// pickerStyle used to live here as local consts; lifted 24 Sept 2026 into
// @/components/form-fields (see that file's header) so the group-details
// editor can share them without drift. Values unchanged.
