...
export const FIELD_RULES = `- activity: one or two words in the founder's own words, naming the activity itself (e.g. "climbing", "beers", "board games"). Name the thing itself, not the doing of it: a founder who writes "we climb" gives activity "climbing", and "we play board games" gives "board games". Drop location and filler words: "climbing at the gym" is just "climbing".
